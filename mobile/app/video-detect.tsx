...
// [STEP 9] เพิ่ม Component สำหรับให้คะแนนดาว + ส่ง Feedback หลังตรวจเสร็จ
...
export default function VideoDetectScreen() {
  ...
  const saveCurrentImage = () => {
    ...
    // ตอนนี้ backend บันทึกรูปเข้า Supabase ให้อัตโนมัติหลัง Detect แล้ว
    setBackendStatus("💾 ภาพผลลัพธ์ถูกบันทึกผ่าน Supabase หลังตรวจแล้ว");
  };
  ...
  return (
    <SafeAreaView style={styles.screen}>
      {/* [STEP 9.5] KeyboardAvoidingView กันคีย์บอร์ดทับช่องพิมพ์ Feedback */}
      <KeyboardAvoidingView
      ...
      >
        ...
        >
          ...
          {/* [STEP 9] Feedback สำหรับผลตรวจแบบวิดีโอ
              แนะนำให้แสดงหลังหยุดตรวจแล้วเท่านั้น
          ...
          {/* [STEP 9] ข้อความเตือน ถ้ายังตรวจแบบต่อเนื่องอยู่ */}
          {detectResult?.scan_id && isRunning && (
            <Text style={styles.feedbackHint}>
              หยุดตรวจก่อน แล้วค่อยให้คะแนนผลวิเคราะห์ล่าสุด
            </Text>
          )}
        </ScrollView>
      </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  // [STEP 9.5] ใช้ร่วมกับ KeyboardAvoidingView
  keyboardAvoiding: {
    flex: 1,
  },

  // [STEP 9.5] แยก style ของ ScrollView ออกมาให้อ่านง่าย
  scroll: {
    flex: 1,
  },
  ...
  scrollContent: {
    ...
    paddingTop: 46,
    paddingBottom: 180, // [STEP 9.5] เพิ่มพื้นที่ล่างกันคีย์บอร์ดบังช่องพิมพ์
  },
  ...
  // [STEP 9] ข้อความเตือนก่อนให้ Feedback ในโหมดวิดีโอ
  feedbackHint: {
    marginTop: 10,
    paddingVertical: 10,
    paddingHorizontal: 12,
